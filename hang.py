"""Hangman
Standard game of Hangman - Game. A word is chosen at random from a list and the
user must guess the word letter by letter before running out of attempts(10 attempts)."""
...
""")
        ...
        if "-" not in word_guessed: # no blanks remaining
            print(("\nCongratulations! You Won. !! {} was the word").format(chosen_word))
        else: # loop must have ended because attempts reached 0
            print(("\nOops..Unlucky! The word was {}.").format(chosen_word))
